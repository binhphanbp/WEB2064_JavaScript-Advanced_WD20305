...
console.log(title); // HTMLCollection
...
//* document.querySelectorAll() trả về NodeList (gần giống như Array)
const result2 = document.querySelectorAll('#heading');
console.log(result2); // NodeList

const result3 = document.querySelectorAll('.title:not(.abc)');
console.log(result3); // NodeList

const result4 = document.querySelectorAll('#heading ~ .title:not(.abc');
console.log(result4); // NodeList
