...
dataMap.set('name', 'Binh');
dataMap.set(21, 21);
dataMap.set({ id: 1 }, 'Object Key');
dataMap.delete('name');
console.log(map);

//? Set: Không trùng nhau
const arr5 = [1, 2, 3, 3, 4, 4, 4, 5];
const arrSet = [...new Set(arr5)];
console.log(arrSet); // Output: [1, 2, 3, 4, 5]
