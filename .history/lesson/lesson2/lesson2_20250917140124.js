...
// console.log('Tiếp tục chạy các code khác');
...
loiChao.call(user1, 'Xin chào', '!');
loiChao.call(user2, 'Hello', '^^');
loiChao.apply(user1, ['Xin chào', '!']);
loiChao.apply(user2, ['Hello', '^^']);
